...
with open('firstrun.txt', 'a+') as f:
    ...
    if f_contents == '1':
        ...
        First_time.iconbitmap('icon.ico')
...
def Pw_Notebook():
    ...
    notebook.iconbitmap('icon.ico')

    # Function for reloading a Password Notebook.
    ...
    # Creating a Label Frame to House Stuff.
    db_frame = LabelFrame(
...
def Authentication1():
    ...
    Authenticate.iconbitmap('icon.ico')
